...
var link_repository_1 = require("./link.repository");
var Link = /** @class */ (function () {
    function Link() {
    }
    Link.prototype.loadHits = function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                        _a = this;
                        return [4 /*yield*/, link_repository_1.HitRepository().count({
                                link_id: this.id,
                            })];
                    case 1:
                        _a.hits = _b.sent();
    ...
    __decorate([
        typeorm_1.Column(),
        __metadata("design:type", String)
    ], Link.prototype, "original_url", void 0);
    __decorate([
        typeorm_1.Column(),
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], Link.prototype, "webhook", void 0);
    __decorate([
        typeorm_1.Column({ type: "simple-json", nullable: true }),
        __metadata("design:type", Object)
    ], Link.prototype, "webhook_meta", void 0);
    __decorate([
        typeorm_1.DeleteDateColumn(),
        __metadata("design:type", Date)
    ], Link.prototype, "deleted_at", void 0);
    __decorate([
